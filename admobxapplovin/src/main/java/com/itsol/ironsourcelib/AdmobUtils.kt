...
import com.itsol.ironsourcelib.NativeFunc.Companion.populateNativeAdView
import com.itsol.ironsourcelib.NativeFunc.Companion.populateNativeAdViewNoBtn
import com.itsol.ironsourcelib.utils.SweetAlert.SweetAlertDialog
import com.itsol.ironsourcelib.utils.admod.callback.AdCallBackInterLoad
import com.itsol.ironsourcelib.utils.admod.callback.AdLoadCallback
...
import com.itsol.ironsourcelib.utils.admod.callback.NativeFullScreenCallBack
import com.itsol.ironsourcelib.utils.admod.NativeHolderAdmob
import com.itsol.ironsourcelib.utils.admod.RewardHolderAdmob
import com.itsol.ironsourcelib.utils.admod.callback.RewardAdCallback
import com.itsol.ironsourcelib.utils.admod.RewardedInterstitialHolderAdmob
import com.itsol.ironsourcelib.utils.admod.remote.BannerPlugin
...
object AdmobUtils {
    ...
    fun getAdSizeInline(context: Activity): AdSize {
        // Step 2 - Determine the screen width (less decorations) to use for the ad width.
        val display = context.windowManager.defaultDisplay
        val outMetrics = DisplayMetrics()
        display.getMetrics(outMetrics)
    ...
    interface AdsNativeCallBackAdmod {
        ...
        fun onPaidNative(nativeAd: NativeAd, adValue: AdValue, adUnitAds: String)
    }
